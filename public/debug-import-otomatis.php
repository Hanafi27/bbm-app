...
echo "<h1>🔍 Debug Import Otomatis</h1>";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['file'])) {
    ...
    if ($file['error'] !== UPLOAD_ERR_OK) {
        ...
        if (!in_array($file['type'], $allowed_types)) {
            ...
            echo "<p style='color: green;'>✅ File valid, mulai analisis...</p>";
            ...
            if (isset($analysis_result['errors'])) {
                ...
                echo "<p style='color: red;'>❌ Analysis errors found</p>";
            } else {
                $analysis_data = $analysis_result;
                $show_analysis = true;
                echo "<p style='color: green;'>✅ Analysis completed successfully</p>";
            }
        }
    }
}
...
function analyze_sales_file($file, $pdo) {
    echo "<h3>🔄 Analyzing Sales File...</h3>";
    $data = [];
    $errors = [];
    $rekap_per_shift = [];
    ...
    echo "<p>Total data rows: " . count($data) . "</p>";
    echo "<p>Total shifts: " . count($rekap_per_shift) . "</p>";
...
<html>
<head>
    <title>Debug Import Otomatis</title>
    <style>
...
<body>
    <div class="container">
        <h1>🔍 Debug Import Otomatis</h1>
        
        <div class="form-container">
            <form method="post" enctype="multipart/form-data">
                <h3>Upload File untuk Debug Import Otomatis</h3>
